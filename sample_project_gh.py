...
with interaccion_usuario:
    ...
    st.sidebar.header("FILTROS POR PRECIO MÍNIMO Y CALCULADORA POR KILÓMETROS:")
    
    pages_names = ['Código Postal', 'Provincia', 'Localidad', 'Proveedor de Servicio', 'Calculadora por kilómetros']
